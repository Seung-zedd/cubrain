...
public class AuthDto {
    ...
    public record AuthRequestDto(
            @NotBlank(message = "Email is required") @Email(message = "Invalid email format") @Schema(description = "User email address", example = "user@example.com") String email) {
    ...
    public record VerifyRequestDto(
            ...
            @NotBlank(message = "Verification code is required") @Schema(description = "6-digit verification code", example = "123456") String code) {
