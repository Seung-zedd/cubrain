...
**소스 코드 열람 시 `backend/src/main/java/` 내의 주요 비즈니스 로직(특히 PDF 처리 및 AI 프롬프트 엔진)을 중점적으로 검토해 주시면 감사하겠습니다.**
...
<img width="1791" height="880" alt="system architecture diagram" src="https://github.com/user-attachments/assets/56fcfca3-99b3-41e6-b3d0-677a76b5aa62" />
