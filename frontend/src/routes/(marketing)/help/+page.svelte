...
<svelte:head>
  <title>Help Center | Cubrain</title>
  <meta
    name="description"
    content="Cubrain Help Center and Frequently Asked Questions."
  />
</svelte:head>

<div
  class="min-h-screen bg-black/95 text-white/80 font-light tracking-tight py-20 px-6"
>
  <div class="max-w-3xl mx-auto">
    ...
    <div class="space-y-4">
      {#each faqs as faq, i (faq.question)}
        <div
          class="rounded-2xl bg-white/2 backdrop-blur-md border outline-none transition-all duration-300 {openIndex ===
          i
            ? 'border-amber-400 ring-1 ring-amber-400/50 bg-white/4'
        ...
        >
          ...
          >
            ...
            <ChevronDown
              class="w-5 h-5 text-white/40 transition-transform duration-300 {openIndex ===
              i
          ...
          {#if openIndex === i}
            <div
              ...
              class="px-6 pb-6 text-white/70 leading-relaxed text-base"
            >
    ...
    <div
      class="mt-16 pt-8 border-t border-white/10 text-center flex flex-col items-center"
    >
      <p class="text-white/60 mb-6 text-lg">Still need help?</p>
      ...
      >
        <a
          ...
          class="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl font-medium bg-white/2 border border-white/10 text-white hover:bg-amber-400/10 hover:text-amber-400 hover:border-amber-400/30 transition-all shadow-[0_4px_14px_0_rgba(0,0,0,0.1)] w-full sm:w-auto"
        >
          Open Mail App
        </a>
        ...
        <button
          ...
          class="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl font-medium bg-white/2 border border-white/10 {copied
      ...
      <p class="text-white/40 mt-6 text-sm">
        Or reach us explicitly at <span class="text-white/60 font-medium"
